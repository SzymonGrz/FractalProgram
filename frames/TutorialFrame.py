    ...
    def __showCanvas(self, frac_name : str):
        ...
        match(frac_name):
            case 'chaos':
                ...
                self.__canvas.create_text(215, 285, text = "Wczytaj przykładowe dane\n", anchor=tk.W, justify="left")
                self.__canvas.create_text(220, 350, text = "Lista dodanych punktów,\n mozna ją edytować poprzez kliknięcie wybranej pozycji", anchor=tk.W, justify="left")
            case 'ifs':
                self.img = Image.open(resource_path("images/ifs.png"))
                self.img = ImageTk.PhotoImage(self.img)
                self.__canvas.create_image(200, 255, image = self.img)
                ...
                self.__canvas.create_text(215, 370, text = "Wczytaj przykładowe dane\n", anchor=tk.W, justify="left")
                self.__canvas.create_text(300, 420, text = "Lista dodanych funkcji, mozna ją edytować poprzez kliknięcie wybranej pozycji", anchor=tk.W, justify="left")
            case 'lsys':
                self.img = Image.open(resource_path("images/lsystem.png"))
                self.img = ImageTk.PhotoImage(self.img)
                self.__canvas.create_image(180, 310, image = self.img)
                ...
                self.__canvas.create_text(320, 395, text = "Wczytaj przykładowe dane\n", anchor=tk.W, justify="left")
                self.__canvas.create_text(300, 450, text = "Lista obsługiwanych znaków", anchor=tk.W, justify="left")
                self.__canvas.create_text(300, 570, text = "Lista dodanych funkcji", anchor=tk.W, justify="left")                          
            case 'rect':
                ...
                self.__canvas.create_text(370, 560, text = "Opcje pozwalające na narysowanie i usunięcie obrazu\n"
                    "a także zapisanie i wczytanie konfiguracji", anchor=tk.W, justify="left")
                self.__canvas.create_text(215, 590, text = "Wczytaj przykładowe dane\n", anchor=tk.W, justify="left")
            case 'mandelbrot':
                self.img = Image.open(resource_path("images/mandel_julia.png"))
                self.img = ImageTk.PhotoImage(self.img)
                self.__canvas.create_image(120, 120, image = self.img)
                ...
                self.__canvas.create_text(215, 200, text = "Wczytaj przykładowe dane\n", anchor=tk.W, justify="left")
            case _ :
                pass